...
$baseUrl = 'http://localhost/appfb/ishalistore/application/layouts/tmpstore/images/thongtinsp/';
//$baseUrl = 'https://ishalimedia.com/appfb/ishalistore/application/layouts/tmpstore/images/thongtinsp/';
